...
class Arsip_model extends CI_Model {
	 ...
	 function get_all() 
  {
    $this->datatables->select('no_dokumen,no_po,tgl_po,deskripsi,jurubeli,proyek,vendor,jurubeli.nama_jurubeli as nm_jurubeli,proyek.nama_proyek as nm_proyek,vendor.nama_vendor as nm_vendor,rak_ke,petugas.nama_petugas as petugas,petugas.no_petugas as no_petugas,tgl_entry,dokumen,status_dokumen');
