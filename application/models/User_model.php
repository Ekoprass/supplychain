...
class User_model extends CI_Model{
  ...
  function get_all_jb() 
  {
    ...
    '<a href="javascript:void(0);" class="edit_record btn btn-warning btn-s" data-no_petugas="$1" data-nama_petugas="$2" data-username="$3" data-password="$4" data-hak_akses="$5">EDIT &nbsp <i class="fa fa-edit"></a>',
